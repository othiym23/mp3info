...
describe Mp3Info, "when reading the MP3 info from an encoding of RAC's 'Distance [remake]'" do
  ...
  it "should verify that the LAME tag's CRC is 0x84D9 the same as eyeD3" do
...
describe Mp3Info, "when reading the MP3 info from an encoding of Wire's 'I Feel Mysterious Today'" do
  ...
  it "should verify that the Xing header says the stream has a quality of 77 the same as eyeD3" do
  ...
  it "should verify that the version of LAME used was 3.96r the same as eyeD3" do
...
describe Mp3Info, "when reading the MP3 info from an encoding of Jürgen Paape's 'Fruity Loops 1'" do
  ...
  it "should verify that the MPEG header claims a bitrate of 320kbps the same as eyeD3" do
