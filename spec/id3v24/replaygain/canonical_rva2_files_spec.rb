...
describe Mp3Info, "when reading a set of files with RVA2 tags with verified replaygain values" do
  it "should find the correct gain values for the original file" do
    @mp3 = Mp3Info.new(File.join(__dir__, "../../../sample-metadata/Replay Gain RVA2/00-RVA2-orig.mp3"))
  ...
  it "should find the correct gain values for a file softened by 2 dB" do
    @mp3 = Mp3Info.new(File.join(__dir__, "../../../sample-metadata/Replay Gain RVA2/01-FC00-2dBsofter-trackonly.mp3"))
    expect(@mp3.has_id3v2_tag?).to be true
  ...
  it "should find the correct gain values for a file softened by 4 dB" do
    @mp3 = Mp3Info.new(File.join(__dir__, "../../../sample-metadata/Replay Gain RVA2/02-F800-4dBsofter-trackonly.mp3"))
    expect(@mp3.has_id3v2_tag?).to be true
    expect(@mp3.id3v2_tag["RVA2"]).not_to be_nil
    expect(@mp3.id3v2_tag["RVA2"].identifier).to eq("track")
    expect(@mp3.id3v2_tag["RVA2"].adjustments.size).to eq(1)
  ...
  it "should find the correct gain values for a file softened by 11 dB" do
    @mp3 = Mp3Info.new(File.join(__dir__, "../../../sample-metadata/Replay Gain RVA2/03-EA00-8dBsofter-trackonly.mp3"))
    expect(@mp3.has_id3v2_tag?).to be true
    expect(@mp3.id3v2_tag["RVA2"]).not_to be_nil
    expect(@mp3.id3v2_tag["RVA2"].identifier).to eq("track")
    expect(@mp3.id3v2_tag["RVA2"].adjustments.size).to eq(1)
  ...
  it "should find the correct gain values for a file softened by 18 dB" do
    @mp3 = Mp3Info.new(File.join(__dir__, "../../../sample-metadata/Replay Gain RVA2/04-DC00-12dBsofter-trackonly.mp3"))
    expect(@mp3.has_id3v2_tag?).to be true
    expect(@mp3.id3v2_tag["RVA2"]).not_to be_nil
    expect(@mp3.id3v2_tag["RVA2"].identifier).to eq("track")
    expect(@mp3.id3v2_tag["RVA2"].adjustments.size).to eq(1)
  ...
  it "should find the correct gain values for a file softened by 25 dB" do
    @mp3 = Mp3Info.new(File.join(__dir__, "../../../sample-metadata/Replay Gain RVA2/05-CE00-16dBsofter-trackonly.mp3"))
    expect(@mp3.has_id3v2_tag?).to be true
    expect(@mp3.id3v2_tag["RVA2"]).not_to be_nil
    expect(@mp3.id3v2_tag["RVA2"].identifier).to eq("track")
    expect(@mp3.id3v2_tag["RVA2"].adjustments.size).to eq(1)
  ...
  it "should find the correct gain values for a file emboldened by 2 dB" do
    @mp3 = Mp3Info.new(File.join(__dir__, "../../../sample-metadata/Replay Gain RVA2/07-0400-2dBlouder-trackonly.mp3"))
    expect(@mp3.has_id3v2_tag?).to be true
    expect(@mp3.id3v2_tag["RVA2"]).not_to be_nil
    expect(@mp3.id3v2_tag["RVA2"].identifier).to eq("track")
    expect(@mp3.id3v2_tag["RVA2"].adjustments.size).to eq(1)
  ...
  it "should find the correct gain values for a file emboldened by 4 dB" do
    @mp3 = Mp3Info.new(File.join(__dir__, "../../../sample-metadata/Replay Gain RVA2/08-0800-4dBlouder-trackonly.mp3"))
    expect(@mp3.has_id3v2_tag?).to be true
    expect(@mp3.id3v2_tag["RVA2"]).not_to be_nil
    expect(@mp3.id3v2_tag["RVA2"].identifier).to eq("track")
    expect(@mp3.id3v2_tag["RVA2"].adjustments.size).to eq(1)
  ...
  it "should find the correct gain values for a file emboldened by 12 dB" do
    @mp3 = Mp3Info.new(File.join(__dir__, "../../../sample-metadata/Replay Gain RVA2/09-1800-12dBlouder-trackonly.mp3"))
    expect(@mp3.has_id3v2_tag?).to be true
    expect(@mp3.id3v2_tag["RVA2"]).not_to be_nil
    expect(@mp3.id3v2_tag["RVA2"].identifier).to eq("track")
    expect(@mp3.id3v2_tag["RVA2"].adjustments.size).to eq(1)
  ...
  it "should find the correct gain values for a file emboldened by 16 dB" do
    @mp3 = Mp3Info.new(File.join(__dir__, "../../../sample-metadata/Replay Gain RVA2/09-2000-16dBlouder-trackonly.mp3"))
    expect(@mp3.has_id3v2_tag?).to be true
    expect(@mp3.id3v2_tag["RVA2"]).not_to be_nil
    expect(@mp3.id3v2_tag["RVA2"].identifier).to eq("track")
    expect(@mp3.id3v2_tag["RVA2"].adjustments.size).to eq(1)
