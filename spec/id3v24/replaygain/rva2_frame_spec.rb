...
describe ID3V24::RVA2Frame, "when strictly interpreting the ID3v2.4 specification" do
  ...
  it "should return a parse error if there are some extra bytes in the raw data" do
    expect { ID3V24::RVA2Frame.from_s("test\x00\x01\x00\x00\x00\x00") }.to raise_error(ID3V24::RVA2ParseError)
    expect { ID3V24::RVA2Frame.from_s("test\x00\x01\x00\x00\x00\x00\x00") }.to raise_error(ID3V24::RVA2ParseError)
    expect { ID3V24::RVA2Frame.from_s("test\x00\x01\x00\x00\x00\x00\x00\x00") }.to raise_error(ID3V24::RVA2ParseError)
  end
